            ...
            >
              <div className='opacity-0 group-hover:opacity-100 flex justify-center items-center flex-col'>
                ...
                <div className='pt-8 text-center'>
                  <a href={work.github_url}><button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>Demo</button></a>
                  <a href={work.demo_url}><button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>Code</button></a>
                </div>
              </div>
            </div>
            )
