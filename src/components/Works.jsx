...
const Works = () => {
	return (
		<div name='work' className='w-full md:h-screen text-gray-300 bg-[#0a192f]'>
			<div className='max-w-[1000px] mx-auto p-4 flx flex-col justify-center w-full h-full'>
				...
				<div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
					...
					>
						<div className='opacity-0 group-hover:opacity-100 flex justify-center itms-center flex-col'>
